...
from apps.sales.serializers import SaleCreateSerializer, SaleOrderSerializer
...
class SaleOrderViewSet(viewsets.ModelViewSet):
    queryset = SaleOrder.objects.select_related("store", "salesperson").prefetch_related("items", "items__medicine").all()
    permission_classes = [SalesPermission]
    search_fields = ["order_no", "customer_name", "salesperson__full_name", "store__name"]
