    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_by",
                    models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="announcements", to=settings.AUTH_USER_MODEL, verbose_name="发布人"),
                ),
            ],
